//**************************************************************************
// Class for defining matrices
//
// Domingo Martin Perandres 2003,2004,2005,2006,2007,2008,2009
//
// GPL3
//
//**************************************************************************
...
_matrix4 	&rotate(_vertex3<Type> Vector1, Type Angle=0);
...
// We align the arbitrary axis with the z axis 
//*************************************************************************

template <class Type> _matrix4<Type> &
_matrix4<Type>::rotate(_vertex3<Type> Vector1, Type Angle)
{
float Angle1;
_matrix4f M1,M2,M3,M4,M5,MFinal;

// rotation about X axis
Angle1=atan2f(Vector1.y,Vector1.z)*180.0/M_PI;
//printf("Angle1=%f\n",Angle1);
M1.rotate_axis_x(Angle1);
M5.rotate_axis_x(-Angle1);
Vector1*=M1;
//Vector1.show_values();
// rotation about Y axis
Angle1=atan2f(Vector1.x,Vector1.z)*180.0/M_PI;
//printf("Angle2=%f\n",-Angle1);
M2.rotate_axis_y(-Angle1);
M4.rotate_axis_y(Angle1);
Vector1*=M2;
//Vector1.show_values();
// rotation about Z axis
M3.rotate_axis_z(Angle1);
// composing
M1*=M2;
M1*=M3;
M1*=M4;
...
template <class Type> _matrix4<Type> &
_matrix4<Type>::swap_columns(int Colum1,int Colum2)
{
Type a0,a1,a2,a3;
...
a2=Value[2][Colum1];
a3=Value[3][Colum1];
Value[0][Colum1]=Value[0][Colum2];
Value[1][Colum1]=Value[1][Colum2];
Value[2][Colum1]=Value[2][Colum2];
Value[3][Colum1]=Value[3][Colum2];
Value[0][Colum2]=a0;
Value[1][Colum2]=a1;
Value[2][Colum2]=a2;
Value[3][Colum2]=a3;
