...
/**
 *
 *   This file is part of casa.h
 *
 *   casa.h is free software: you can redistribute it and/or modify
 *   it under the terms of the GNU General Public License as published by
 *   the Free Software Foundation, either version 3 of the License, or
 *   (at your option) any later version.
 *
 *   casa.h is distributed in the hope that it will be useful,
...
void casa::creaCasa()
{
    ...
    // cuadro_6 (gracioso)
    cuadro[5].construir(30,30,"esmeralda","BMP/cuadro6.bmp");
    //cubo basura
